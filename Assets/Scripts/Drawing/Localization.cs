    ...
    public static class Localization
    {
        ...
        static readonly Dictionary<string, Dictionary<string, string>> Tables = new()
        {
            ["en"] = new Dictionary<string, string>
            {
                ...
                ["tutorial.step.open"]     = "Open the palette",
                ...
                ["tutorial.step.brush"]    = "Try the Ribbon and Dashed brushes",
                ["tutorial.step.line"]     = "Turn on Line, draw a straight line, then turn it off",
                ["tutorial.step.erase"]    = "Pick Erase, rub out a stroke, then go back to Draw",
                ["tutorial.btn.trigger"]   = "Trigger",
                ["tutorial.btn.grip"]      = "Grip",
                ["tutorial.ctrl.right"]    = "Right controller",
                ["tutorial.ctrl.left"]     = "Left controller",
            ...
            ["it"] = new Dictionary<string, string>
            {
                ...
                ["tutorial.step.open"]     = "Apri la palette",
                ...
                ["tutorial.step.brush"]    = "Prova i pennelli Nastro e Tratteggiato",
                ["tutorial.step.line"]     = "Attiva Line, disegna una linea dritta, poi disattivala",
                ["tutorial.step.erase"]    = "Seleziona Cancella, cancella un tratto, poi torna a Disegna",
                ["tutorial.btn.trigger"]   = "Grilletto",
                ["tutorial.btn.grip"]      = "Grip",
                ["tutorial.ctrl.right"]    = "Controller destro",
                ["tutorial.ctrl.left"]     = "Controller sinistro",
